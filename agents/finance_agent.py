...
finance_agent = Agent(
    ...
    instructions = dedent("""\
                          ...
                          - Highlight key insignts with bullet points
...
finance_agent.print_response(
    "What's the latest news and financial performance of Apple (APPL)", stream = True
)
...
4. "Analyze Intel's foundry strategy impact on its stock performance"
5. "Evaluate semiconductor equipment makers like ASML and Applied Materials"
