...
os.environ["SLACK_API_KEY"] = os.getenv("SLACK_API_KEY")

knowledge_base = PDFKnowledgeBase(
    path="tmp/data",
    vector_db=PgVector(table_name="autonomous_startup_team",
...
legal_complaince_agent = Agent(
    name = "Legal Complieance Agent",
    role = "Legal Complaince",
